...
@section('title', 'Subcontractor RA Bills')
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h1 class="h4 mb-0">Subcontractor RA Bills</h1>

        <a href="{{ route('accounting.subcontractor-ra.create') }}" class="btn btn-primary btn-sm">
            + New Subcontractor RA Bill
        </a>
    </div>
        ...
        <div class="card-body">
            <form method="GET" class="row g-2 align-items-end">
                <div class="col-md-3">
                    ...
                    <select name="subcontractor_id" class="form-select form-select-sm">
                        ...
                        @foreach($subcontractors as $p)
                            <option value="{{ $p->id }}" @selected(request('subcontractor_id') == $p->id)>
                                {{ $p->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-12 mt-2">
                    ...
                    <a href="{{ route('accounting.subcontractor-ra.index') }}" class="btn btn-link btn-sm">Reset</a>
                </div>
            </form>
        </div>
    </div>
            ...
            <div class="table-responsive">
                <table class="table table-sm table-hover mb-0 align-middle">
                    ...
                    <tr>
                        ...
                        <th class="text-end" style="width: 12%">Payable</th>
                    ...
                    @forelse($raBills as $bill)
                        <tr>
                            <td>
                                ...
                                @if($bill->bill_number)
                                    <div class="small text-muted">Bill: {{ $bill->bill_number }}</div>
                                @endif
                    ...
                    @empty
                        <tr>
                            <td colspan="10" class="text-center text-muted py-3">No subcontractor RA bills found.</td>
                        </tr>
                    @endforelse
                    </tbody>
                </table>
