...
@section('content')
                                            ...
                                            <div class="btn-group btn-group-sm">
                                                ...
                                                @if($attendance->status->value !== 'weekly_off' && $attendance->status->value !== 'holiday')
                                                    @can('hr.attendance.update')
                                                        <a href="{{ route('hr.attendance.manual-entry', ['date' => $date]) }}" class="btn btn-outline-primary" title="Edit"
                                                            onclick="storeAttendance(
                                                               {{ $attendance->hr_employee_id }},
                                                               '{{ $date }}',
                                                               '{{ $attendance->status }}',
                                                               '{{ optional($attendance->first_in)->format('H:i') }}',
                                                               '{{ optional($attendance->last_out)->format('H:i') }}',
        ...
        @push('scripts')
           ...
           <script>
    function storeAttendance(hrEmployeeId, attendanceDate, status, firstIn, lastOut, remarks) {
        localStorage.setItem('manual_entry_employee_id', hrEmployeeId);
        localStorage.setItem('manual_entry_date', attendanceDate);
        localStorage.setItem('manual_entry_status', status);
        localStorage.setItem('manual_entry_first_in', firstIn);
        localStorage.setItem('manual_entry_last_out', lastOut);
        localStorage.setItem('manual_entry_remarks', remarks);
    }
    </script>
            <script>
