                ...
                <form method="GET" class="row g-3 align-items-end">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" id="bsLedgerSearch" class="form-control"
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="card h-100 bs-stat-card">
                    <div class="card-body py-3">
                        ...
                        <div class="h5 mb-0">{{ number_format(abs($totalAssets), 2) }} <span
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="card h-100 bs-stat-card">
                    <div class="card-body py-3">
                        ...
                        <div class="h5 mb-0">{{ number_format(abs($totalLiabilities), 2) }} <span
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm table-bordered mb-0 align-middle">
                                ...
                                @foreach($assetGroups as $g)
                                            ...
                                            <td class="small fw-semibold" colspan="2">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <button type="button"
                                                            class="btn btn-link btn-sm text-decoration-none p-0 me-2 bs-group-toggle"
                                                    ...
                                                    <span class="text-muted fw-bold">
                                                        Total : {{ number_format(abs($gt), 2) }} {{ $gDrCr }}
                                                    </span>
                                    ...
                                    <tbody id="{{ $collapseId }}" class="collapse show bs-group-collapse"
                                        ...
                                        @foreach($g['accounts'] as $row)
                                                ...
                                                'to_date' => $ledgerTo,
                                                                                                                                ...
                                                                                                                                @if(!empty($row['account']->code))
                                                                                                                                    <span
                                                                                                                                        class="badge bg-body-secondary text-body me-1">{{ $row['account']->code }}</span>
                                                                                                                                @endif
                                ...
                                <tbody>
                                    @if(empty($assetGroups))
                                        <tr class="bs-static-row">
                                            <td colspan="2" class="text-center small text-muted py-3">No asset-side ledgers
                                                found.</td>
                                        </tr>
                                    @endif
                                ...
                                <tfoot>
                                    <tr class="table-dark text-white fw-semibold bs-static-row">
                                        ...
                                        <td class="small text-end">{{ number_format(abs($totalAssets), 2) }}
                                            {{ $assetsDrCr }}</td>
                                    </tr>
                                </tfoot>
                            </table>
                            ...
                            <table class="table table-sm table-bordered mb-0 align-middle">
                                    ...
                                    <td class="small fw-semibold" colspan="2">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <button type="button" class="btn btn-link btn-sm text-decoration-none p-0 me-2 bs-group-toggle"
                                                    data-bs-toggle="collapse" data-bs-target="#{{ $collapseId }}" aria-controls="{{ $collapseId }}"
                                                    aria-expanded="true">
                                                    <i class="bi bi-dash-square"></i>
                                                </button>
                                ...
                                <tbody>
                                    @if(empty($liabilityGroups))
                                        <tr class="bs-static-row">
                                            <td colspan="2" class="text-center small text-muted py-3">No liability/equity-side
                                                ledgers found.</td>
                                        </tr>
                                    @endif
                                ...
                                <tfoot>
                                    <tr class="table-dark text-white fw-semibold bs-static-row">
                                        ...
                                        <td class="small text-end">{{ number_format(abs($totalLiabilities), 2) }}
                                            {{ $liabDrCr }}</td>
                                    </tr>
                                </tfoot>
                            </table>
