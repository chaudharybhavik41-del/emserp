                    ...
                    <tbody>
                        ...
                        @php
                            ...
                            foreach ($rows as $r) {
                                ...
                                $groupTotals[$gid]['debit'] += $r['debit'];
                                $groupTotals[$gid]['credit'] += $r['credit'];
                            }
                        @endphp
                            ...
                            @foreach($rows as $row)
                                            ...
                                            @if($currentGroupId !== $gid)
                                                ...
                                                @if(!is_null($currentGroupId))
                                                    <tr class="table-light fw-semibold tb-group-subtotal" data-group-key="{{ $groupKey }}"
                                                ...
                                                <tr class="table-secondary tb-group-header" data-group-key="{{ $groupKey }}"
                                                    data-group-name="{{ strtolower($currentGroupName) }}">

                                                    <td class="small fw-semibold">
                                                        <button type="button" class="btn btn-link btn-sm text-decoration-none p-0 tb-group-toggle"
                                                            data-group-key="{{ $groupKey }}" data-expanded="true">
                                                    ...
                                                    <td class="small text-end fw-semibold">
                                                        {{ number_format($groupTotals[$gid]['debit'], 2) }}
                                                    </td>

                                                    <td class="small text-end fw-semibold">
                                                        {{ number_format($groupTotals[$gid]['credit'], 2) }}
                                                    </td>
                                            ...
                                            <tr class="tb-account-row" data-group-key="{{ $groupKey }}" data-row-text="{{ $searchText }}">
