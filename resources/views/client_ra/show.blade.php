...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-start mb-3">
            <div>
                <h1 class="h4 mb-1">Client Billing: {{ $clientRa->ra_number }}</h1>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="row g-2">
                            ...
                            <div class="col-md-4"><div class="small text-muted">Bill Kind</div><div class="fw-semibold">{{ $clientRa->bill_kind_label }}</div></div>
                            <div class="col-md-4"><div class="small text-muted">Source Basis</div><div class="fw-semibold">{{ $clientRa->source_basis_label }}</div></div>
                            <div class="col-md-4"><div class="small text-muted">Material Scope</div><div class="fw-semibold">{{ $clientRa->material_scope_label }}</div></div>
                            ...
                            <table class="table table-sm table-bordered mb-0 align-middle">
                                ...
                                @foreach($clientRa->lines as $line)
                                    <tr>
                                        ...
                                        <td>
                                            @if($line->productionV2Dispatch)
                                                <div class="small fw-semibold">{{ $line->productionV2Dispatch->dispatch_number }}</div>
                                                <div class="small text-muted">{{ $line->productionV2DispatchLine?->assembly_code_snapshot ?: 'Dispatch line' }}</div>
                                            @else
                                                -
                                            @endif
                                        </td>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="row g-2">
                            ...
                            <div class="col-6"><div class="small text-muted">Round Off</div><div class="fw-semibold">{{ number_format((float) $clientRa->round_off, 2) }}</div></div>
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            @can('client_ra.delete')
                                @if($clientRa->status !== 'posted')
                                    <form method="POST" action="{{ route('accounting.client-ra.destroy', $clientRa) }}" onsubmit="return confirm('Delete this client billing record?')">
                                        @csrf
                                        @method('DELETE')
