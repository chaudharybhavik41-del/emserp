...
@section('content')
    ...
    @if($voucher->isPosted() && !$voucher->isReversed() && !$voucher->reversal_of_voucher_id)
        <div class="modal fade" id="reverseModal" tabindex="-1" aria-labelledby="reverseModalLabel" aria-hidden="true" data-bs-backdrop="false">
    ...
    {{-- Change date modal --}}
    <div class="modal fade" id="changeDateModal" tabindex="-1" aria-labelledby="changeDateModalLabel" aria-hidden="true" data-bs-backdrop="false">
