...
<div class="card border-0 shadow-sm mb-3">
    <div class="card-body py-2">
        <div class="d-flex flex-wrap gap-2">
            ...
            <a href="{{ route('projects.production-v2.billing.index', ['project' => $project->id]) }}" class="btn btn-sm {{ $active === 'billing' ? 'btn-primary' : 'btn-outline-primary' }}">Billing</a>
            ...
            <a href="{{ route('projects.production-v2.dispatches.index', ['project' => $project->id]) }}" class="btn btn-sm {{ $active === 'dispatches' ? 'btn-primary' : 'btn-outline-primary' }}">Dispatch</a>
